              ...
              (match uu____2624 with
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   let rec aux h =
                     ...
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____2659 = FStar_Syntax_Syntax.lid_of_fv fv
                            in
                         (uu____2659, [])
                     ...
                     | uu____2679 -> failwith "wrong Data_app head format"
                      in
                   ...
                   (match uu____2683 with
                    | (head2,universes) ->
                        ...
                        then mk1 (FStar_Parser_AST.Construct (head2, args1))
                          ...
                          (let uu____2720 = FStar_Options.print_universes ()
                              in
                           if uu____2720
                           then
                             mk1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2788 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2819 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____3121  ->
                 ...
                 | (e,uu____3127) ->
                     ...
                     (uu____3128, FStar_Parser_AST.Nothing)) args
             in
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let args1 =
            let uu____3375 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3385  ->
                      match uu____3385 with | (p2,b) -> aux p2))
               in
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____3441 = map21 tl1 tl2  in (hd1, hd2) :: uu____3441
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____3603 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____3665 =
                           let uu____3666 = FStar_Syntax_Subst.compress term
                              in
                ...
                let uu____3904 =
                  let uu____3908 =
                    let uu____3909 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____3916)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____4030 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____4034 =
                       ...
                       let uu____4364 =
                         let uu____4365 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____4372)
                            in
          ...
          (let t' =
             let uu____4401 =
               (let uu____4402 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____4402) || (FStar_List.isEmpty uvs)
                in
             if uu____4401
             then resugar_term t
             else
